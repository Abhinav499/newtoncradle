...
function setup() {
	...
	//rope1 = new Rope(bobObject1.body,-180,0);
	//rope2 = new Rope(roof1.body,bobObject2.body,-100,0);
	rope3 = new Rope(bobObject3.body,{x:400,y:100});
	//rope4 = new Rope(roof1.body,bobObject4.body,60,0);
	//rope5 = new Rope(roof1.body,bobObject5.body,140*1,0);
...
function keyPressed(){
	if(keyCode===UP_ARROW){
		console.log("hello");
	  Matter.Body.applyForce(bobObject3.body,bobObject3.body.position,{x:-100,y:-80});
	}
  }
